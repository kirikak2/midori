...
#elif defined(CONFIG_USB_MIDI_BOARD_M5STACK_TAB5)
    // Tab5 uses SPI mode - pins defined in Kconfig
    #define SD_CLK_PIN  CONFIG_USB_MIDI_SDCARD_TAB5_CLK
    #define SD_MOSI_PIN CONFIG_USB_MIDI_SDCARD_TAB5_MOSI
    #define SD_MISO_PIN CONFIG_USB_MIDI_SDCARD_TAB5_MISO
    #define SD_CS_PIN   CONFIG_USB_MIDI_SDCARD_TAB5_CS
